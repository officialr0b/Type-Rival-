...
export default function RulesPage() {
  return <LegalDocument eyebrow="FAIR-PLAY RULES" title="Your hands. Your score." sections={[
    ...
    { heading: 'Devices and assistance', body: 'Normal phone, tablet, or physical-keyboard input is allowed in this MVP. Ranked Time Trial results are separated into touch, swipe, and hardware lanes. Emulators or accessibility tools may not be used to falsify input. Accessibility accommodations will be documented before organized prize events.' },
