...
export default function PrivacyPage() {
  return <LegalDocument eyebrow="PRIVACY NOTICE" title="Your data stays yours." sections={[
    ...
    { heading: 'Local practice and security', body: 'Guest and under-13 coaching history is stored only in the browser and can be removed by clearing site data. Signed-in coaching history is saved with the account and included in account exports. TypeRival uses access controls, server validation, encrypted connections, and rate limits, but no online service can guarantee absolute security.' },
  ]} />;
}
