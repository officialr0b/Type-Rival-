...
export default function RulesPage() {
  return <LegalDocument eyebrow="FAIR-PLAY RULES" title="Your hands. Your score." sections={[
    ...
    { heading: 'Devices and assistance', body: 'Normal phone, tablet, physical-keyboard, and translated stenography-writer input is allowed in this MVP. Ranked Time Trial results are separated into touch, swipe, hardware, and self-declared stenography lanes. Emulators or accessibility tools may not be used to falsify input. Accessibility accommodations will be documented before organized prize events.' },
    ...
    { heading: 'Challenges and conduct', body: 'Challenge Links expire and may be shared by anyone who receives them. Private Races require a signed-in account and a room invitation. Do not use handles, links, or competition to impersonate, harass, threaten, or reveal private information.' },
